...
const AddCategory = () => {
  ...
  return (
    // Layout chính: Padding nhỏ trên mobile (p-4), lớn trên desktop (md:p-6)
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
      {/* Tăng độ rộng tối đa lên 4xl để desktop nhìn thoáng hơn khi chia 2 cột */}
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-6 bg-white rounded-lg shadow-sm p-4 md:p-6 border border-gray-200">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900">Thêm danh mục mới</h1>
        ...
        >
          ...
          {/* GRID SYSTEM: Mobile 1 cột, Desktop 2 cột */}
          ...
          {/* Buttons: Mobile xếp dọc (đảo ngược), Desktop xếp ngang */}
