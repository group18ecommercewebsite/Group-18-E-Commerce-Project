        ...
        <div className="border-t border-[rgba(0,0,0,0.1)] pt-6 mt-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link to="/" className="w-9 h-9 rounded-full bg-[#3b5998] flex items-center justify-center text-white hover:opacity-80 transition-all duration-300">
                <FaFacebookF className="text-[16px]" />
              </Link>
              <Link to="/" className="w-9 h-9 rounded-full bg-[#ff0000] flex items-center justify-center text-white hover:opacity-80 transition-all duration-300">
                <FaYoutube className="text-[16px]" />
              </Link>
              <Link to="/" className="w-9 h-9 rounded-full bg-[#bd081c] flex items-center justify-center text-white hover:opacity-80 transition-all duration-300">
                <FaPinterestP className="text-[16px]" />
              </Link>
              <Link to="/" className="w-9 h-9 rounded-full bg-[#e4405f] flex items-center justify-center text-white hover:opacity-80 transition-all duration-300">
